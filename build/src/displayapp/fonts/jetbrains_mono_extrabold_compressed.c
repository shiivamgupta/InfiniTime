 ...
 * Size: 80 px
 * Bpp: 1
 * Opts: --size 80 --output jetbrains_mono_extrabold_compressed.c --bpp 1 --format lvgl --no-compress --font /home/shiva/shiv_infinitime/src/displayapp/fonts/JetBrainsMono-ExtraBold.ttf --range 0x30-0x3a
 ******************************************************************************/
